...
const ImgSliderTime = () => {
    ...
    return(
        ...
        <div  className=" w-[1300px] max-w-[97vw]  h-[600px] m-auto relative bg-yellow-500 overflow-hidden top-10 max-md:h-[400px]! ">
           {/* list */}
           <div
                onDragStart={(e) => {dispatch({type : "handlerMouseDown", payload : {e : e, sliderRef : sliderRef.current}})}}
                onDragEnd={(e) => {dispatch({type : "handlerMouseLeave", payload : {e : e, sliderRef : sliderRef.current}})}}
                ref = {sliderRef} 

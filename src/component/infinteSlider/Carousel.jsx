...
const Carousel = ({items}) => {
    ...
    return(
        <div className="w-full max-w-4xl mx-auto relative group select-none" dir="ltr">
            ...
            <button
                onClick={prevSlide}
                className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blue-md hover:bg-white/20 text-white p-3 rounded-full shadow-lg transition-all opacity-0
                group-hover:opacity-100 focus:opacity-100 z-10 disabled:opacity-0"
                disabled = {isTranitioning}
            >
            ...
            <button
                onClick={nextSlide}
                className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blue-md hover:bg-white/20 text-white p-3 rounded-full shadow-lg transition-all opacity-0
                group-hover:opacity-100 focus:opacity-100 z-10 disabled:opacity-0"
                disabled = {isTranitioning}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">

    ...
    return (
        ...
        >
            ...
            <input 
                ...
                className={`${state.delay ? 'w-[100%]' : "w-0!"} border-0  mx-12   outline-0 text-white transition-all  delay-500 duration-1000 `}
            />
           
            <i className={`${state.delay ? 'text-2xl' : 'text-[0px]'} bi bi-mic-fill absolute text-blue-500 hover:text-red-400! hover:delay-0 cursor-pointer not-hover:delay-0 right-[10px] delay-850! transition-all duration-200`}></i>

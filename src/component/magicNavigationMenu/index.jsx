                        ...
                        <ul className="flex w-[350px] ">
                            ...
                            <div 
                                ...
                                className={`
                                    ...
                                    before:content-[''] before:absolute before:top-[57%]  before:left-[-39%] before:w-[23px] before:h-[20px] before:bg-red-400 before:rounded-tr-[20px] before:shadow-[0_-5px_0_2px_#222327]

                    ...
                    <BrowserRouter>
                        <ul className="flex w-[350px] ">
                            ...
                            <div 
                                ...
                                className={`
                                    absolute  -top-[57%] w-[70px] h-[70px] bg-[#29fd53] rounded-[50%] border-6 border-[#29fd53] duration-500 shadow-[0_5px_0_0_#222327]
                                    before:content-[''] before:absolute before:top-[57%]  before:left-[-39%] before:w-[23px] before:h-[20px] before:bg-red-400 before:rounded-tr-[20px] before:shadow-[0_-10px_0_0_#222327]

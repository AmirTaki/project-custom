                        ...
                        <ul className="flex w-[350px] ">
                            ...
                            <div 
                                ...
                                className={`
                                    ...
                                    before:content-[''] before:absolute before:top-[50%]  before:left-[-22%] before:w-[20px] before:h-[20px] before:bg-transparent before:rounded-tr-[20px] before:shadow-[0_-10px_0_0_#10131c]
                                    after:content-[''] after:absolute after:top-[50%] after:right-[-22px] after:w-[20px] after:h-[20px] after:bg-transparent after:rounded-tl-[20px] after:shadow-[0_-10px_0_0_#10131c]
                                `}
                            ></div>
                        </ul>
                    </BrowserRouter>

...
const SwitchButton = () => {
    ...
    return(
        <div 
            className={`${menu ? " right-0  shadow-[5px_5px_50px_#7ef0ff] " : "-right-50 duration-300!  "} top-50  duration-400! flex flex-row  items-center justify-center  fixed w-[200px] h-[300px]  border-2 border-[#7ef0ff] bg-[#10131c]  rounded-4xl z-200!  `}
        >  
            <div className={` 
